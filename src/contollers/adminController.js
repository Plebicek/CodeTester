import { searchUsers, getAllUsers, getGroups, getGrades, getTopics, getTasks, getAnswers } from "../models/admin.js"
...
export async function dashUsers(req,res) {
    ...
    const current = "Users"
    res.render("admin/users", {"sideNav" : navigation, current : current, users : users})
}
...
export async function searchUser(req,res) {
    ...
    res.render("admin/users", {"sideNav":navigation, users : users, current : current})
}
...
export async function dashGrade(req,res) {
    ...
    res.render("admin/grades", {"sideNav" : navigation, current : current, grades : grades, path})
}
...
export async function dashTopic(req,res) {
    ...
    console.log(topics)
    res.render("admin/topics", {"sideNav" : navigation, current : current, topics, path})
}
// === TASKS ===
export async function dashTask(req,res) {
    ...
    console.log(tasks)
    res.render("admin/tasks", {"sideNav" : navigation, current : current, tasks, path})
}
...
export async function dashAnswer(req,res) {
    ...
    console.log(answers)
    res.render("admin/answers", {"sideNav" : navigation, current : current, answers})
}